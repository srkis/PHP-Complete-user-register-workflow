...
if(!$ses->checkSession() && !$ses->checkLogin()){
    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="template/post.html">Sample Post</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="template/change_pass.php">Change Password</a>
